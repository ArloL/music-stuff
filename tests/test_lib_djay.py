...
def test_load_djay_index_maps_key_and_bpm(mock_clone, tmp_path):
    ...
    assert result["0000000000003039"] == DjaySongData(bpm=120.5, manual_bpm=121.0, key="1d", is_straight_grid=False)
    assert result["0000000000010932"] == DjaySongData(bpm=130.0, manual_bpm="", key="3m", is_straight_grid=False)
