...
uv run playlist-csv "Critical Mass 2026-05"
uv run playlist-csv "Critical Mass 2026-06"
uv run playlist-csv "Critical Mass 2026-07"
uv run playlist-csv "Critical Mass 2026-08"
uv run playlist-csv "Critical Mass Next"
uv run playlist-csv "Critical Mass Played"
